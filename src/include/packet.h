...
#define URG_FLAG 1000000000000000
#define ACK_FLAG 0100000000000000
#define PSH_FLAG 0010000000000000
#define RST_FLAG 0001000000000000
#define SYN_FLAG 0000100000000000
#define FIN_FLAG 0000010000000000
